...
REGISTER_IMD_DEVICE(lcd_lq026b3ux01_dev) = {
    .info = {
    ...
    .dclk_cfg        = CLK_DIS | CLK_POSITIVE,
    .sync0_cfg       = SIGNAL_TYPE_DEN | CLK_EN | CLK_NEGATIVE,
    .sync1_cfg       = SIGNAL_TYPE_HSYNC | CLK_DIS | CLK_POSITIVE,
    .sync2_cfg       = SIGNAL_TYPE_VSYNC | CLK_DIS | CLK_POSITIVE,

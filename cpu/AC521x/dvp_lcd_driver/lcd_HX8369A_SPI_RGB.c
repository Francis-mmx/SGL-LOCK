...
static int lcd_hx8369a_init(void *_data)
{
    u8 i;
...
REGISTER_IMD_DEVICE(lcd_hx8369a_spi_rgb_dev) = {
    .info = {
        .test_mode 	     = false,
    ...
    .sync0_cfg       = SIGNAL_TYPE_DEN  | CLK_EN | CLK_POSITIVE,
    ...
    .timing = {
        .hori_total 		    = 595,//12000000/60/288,//
        .hori_sync 		        = 5,
        .hori_back_porth 	    = 40,
        .hori_pixel 	        = 480,
        .vert_total 		    = 880,

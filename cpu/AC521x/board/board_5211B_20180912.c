...
{
#define SD_IO_DECT_PIN IO_PORTG_06
    static u8 init = 0;
    if (!init) {
        init = 1;
...
#define ADC0_03   (0x3ff*03/33) //0x7C
#define ADC0_02   (0x3ff*02/33) //0x3E
#define ADC0_01   (0x3ff*01/33) //0x1F
#define ADC0_00   (0)

#define ADKEY_V_0      	(ADC0_33)//((ADC0_33 + ADC0_30)/2)
#define ADKEY_V_1 		(ADC0_30)//((ADC0_30 + ADC0_27)/2)
#define ADKEY_V_2 		(ADC0_27)//((ADC0_27 + ADC0_23)/2)
#define ADKEY_V_3 		(ADC0_23)//((ADC0_23 + ADC0_20)/2)
#define ADKEY_V_4 		(ADC0_20)//((ADC0_20 + ADC0_17)/2)
#define ADKEY_V_5 		(ADC0_17)//((ADC0_17 + ADC0_13)/2)
#define ADKEY_V_6 		(ADC0_13)//((ADC0_13 + ADC0_09)/2)//up 0.7
#define ADKEY_V_7 		(ADC0_09)//((ADC0_09 + ADC0_06)/2)//down 0.4
#define ADKEY_V_8 		(ADC0_06)//((ADC0_06 + ADC0_03)/2)//ok 0.2
#define ADKEY_V_9 		(ADC0_03)//((ADC0_03 + ADC0_01)/2)//menu/mode 0.1

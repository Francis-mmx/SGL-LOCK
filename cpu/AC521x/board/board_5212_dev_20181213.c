...
#define SD1_DET_PIN IO_PORTH_12
...
SD1_PLATFORM_DATA_BEGIN(sd1_data)
	...
	.data_width 			= 4,
	.speed 					= 40000000,
	.detect_mode 			= SD_IO_DECT, //MSD_CMD_DECT,
...
SW_IIC_PLATFORM_DATA_BEGIN(sw_iic_data)
	.clk_pin = IO_PORTA_06, //IO_PORTD_01,
	.dat_pin = IO_PORTA_08, //IO_PORTD_02,
	.sw_iic_delay = 50,
SW_IIC_PLATFORM_DATA_END()
...
WIFI_PLATFORM_DATA_BEGIN(wifi_data)
    ...
    .sdio_parm = SDIO_GRP_1 | SDIO_PORT_0 | SDIO_1_BIT_DATA | SDIO_CLOCK_26M,
#else
    .sdio_parm = SDIO_GRP_1 | SDIO_PORT_0 | SDIO_1_BIT_DATA | SDIO_CLOCK_26M | SDIO_DATA1_IRQ,
#endif

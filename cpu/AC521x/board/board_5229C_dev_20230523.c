...
#ifdef CONFIG_BOARD_5229C_DEV_20230523
...
#define UART_REMAP_PIN	IO_PORTA_02

//PORTA_10_11,PORTG_6_7,PORTH_12_11,PORTD_4_5,
UART0_PLATFORM_DATA_BEGIN(uart0_data)
	.baudrate = 1000000,//115200,
    .port = PORT_REMAP,
	.channel = OUTPUT_CHANNEL0,//OUTPUT_CHANNEL0 - OUTPUT_CHANNEL3
...
UART2_PLATFORM_DATA_BEGIN(uart2_data)
    .baudrate = 460800,
    .port = PORT_REMAP,
	.channel = OUTPUT_CHANNEL3,//OUTPUT_CHANNEL0 - OUTPUT_CHANNEL3
    .tx_pin = IO_PORTA_11,
    .rx_pin = IO_PORTA_12,
	.max_continue_recv_cnt = 1024,
	.idle_sys_clk_cnt = 500000,
...
int sdmmc_1_io_detect(const struct sdmmc_platform_data *data)
{
    ...
    if (!init) {
        ...
        gpio_set_pull_down(IO_PORTA_13, 0);
    }
...
static const struct camera_platform_data camera0_data = {
    .xclk_gpio      = -1,
	.reset_gpio     = IO_PORTH_12,
    .online_detect  = NULL,
	.pwdn_gpio      = IO_PORTF_01,
    .power_value    = 0,
	.interface      = SEN_INTERFACE0,//SEN_INTERFACE_CSI2,
    .dvp={
        .pclk_gpio   = IO_PORTG_10,
        .hsync_gpio  = IO_PORTG_11,
        .vsync_gpio  = IO_PORTG_12,
...
static const struct camera_platform_data camera1_data = {
    .xclk_gpio      = -1,
	.reset_gpio     = IO_PORT_PR_01,
	.pwdn_gpio      = IO_PORTF_00,
    .power_value    = 0,
...
const struct spiflash_platform_data extflash_data = {
	...
	.mode           = FAST_READ_OUTPUT_MODE,//FAST_READ_IO_MODE,
	.sfc_run_mode   = SFC_FAST_READ_DUAL_OUTPUT_MODE,
    .ext_addr = 2*1024*1024,
    .ext_space = 6*1024*1024,
};
#ifdef CONFIG_PSRAM_ENABLE

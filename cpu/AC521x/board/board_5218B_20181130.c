...
WIFI_PLATFORM_DATA_BEGIN(wifi_data)
    ...
    .sdio_parm = SDIO_GRP_0 | SDIO_PORT_1 | SDIO_4_BIT_DATA | SDIO_CLOCK_26M,
#else
    .sdio_parm = SDIO_GRP_0 | SDIO_PORT_1 | SDIO_4_BIT_DATA | SDIO_CLOCK_26M | SDIO_DATA1_IRQ,
#endif
    .wakeup_port = -1,//IO_PORTG_07,
    .cs_port = -1,
    .power_port = IO_PORTH_12,
#endif
...
#ifdef CONFIG_VIDEO2_ENABLE
    //UVC 后拉供电控制
    gpio_direction_output(IO_PORTH_05, 1);
#endif
    //LCD 4LANE

...
//PORTA_12_13,PORTH_2_5,PORTH_9_10,PORTF_2_3,
...
{
#define SD_IO_DECT_PIN IO_PORTH_07
    static u8 init = 0;
    if (!init) {
        init = 1;
...
static const struct camera_platform_data camera0_data = {
    .xclk_gpio      = IO_PORTH_13, //-1,
	.reset_gpio     = IO_PORTD_00,
    .online_detect  = NULL,
	.pwdn_gpio      = -1,
    .power_value    = 0,
	.interface      = SEN_INTERFACE0,
/* SEN_INTERFACE0,//SEN_INTERFACE_CSI2, */
    .dvp={
...
#define ADC0_13   (0x3ff*13/33) //0x193
#define ADC0_10   (0x3ff*10/33) //
#define ADC0_08   (0x3ff*8/33) //
#define ADC0_06   (0x3ff*06/33) //0x136
#define ADC0_04   (0x3ff*04/33) //0x136
#define ADC0_03   (0x3ff*03/33) //0xD9
#define ADC0_02   (0x3ff*02/33) //0xD9
#define ADC0_01   (0x3ff*01/33) //0x7C
...
#define ADKEY_V_0      	((ADC0_33 + ADC0_30)/2)
#define ADKEY_V_1 		((ADC0_30 + ADC0_27)/2)
#define ADKEY_V_2 		((ADC0_27 + ADC0_17)/2)
#define ADKEY_V_3 		((ADC0_17 + ADC0_13)/2)
#define ADKEY_V_4 		((ADC0_13 + ADC0_10)/2)
#define ADKEY_V_5 		((ADC0_13 + ADC0_08)/2)//
#define ADKEY_V_6 		((ADC0_08 + ADC0_06)/2)//ok 1.4
#define ADKEY_V_7 		((ADC0_06 + ADC0_04)/2)//down 1.0
#define ADKEY_V_8 		((ADC0_04 + ADC0_03)/2)//up 0.7
...
WIFI_PLATFORM_DATA_BEGIN(wifi_data)
    ...
    .sdio_parm = SDIO_GRP_1 | SDIO_PORT_3 | SDIO_1_BIT_DATA | SDIO_CLOCK_26M,
#else
    .sdio_parm = SDIO_GRP_1 | SDIO_PORT_3 | SDIO_1_BIT_DATA | SDIO_CLOCK_26M | SDIO_DATA1_IRQ,
#endif
...
void board_init()
{
    /*  while(1) */
    /* { */
    /* #define TEST_PIN1 IO_PORTD_01		 */
    /* #define TEST_PIN2 IO_PORTD_02		 */
    /* gpio_direction_output(TEST_PIN1,1); */
    /* gpio_direction_output(TEST_PIN2,1); */
    /* delay(100000);	 */
    /* gpio_direction_output(TEST_PIN1,0); */
    /* gpio_direction_output(TEST_PIN2,0); */
    /* delay(100000);	 */
    /* } */

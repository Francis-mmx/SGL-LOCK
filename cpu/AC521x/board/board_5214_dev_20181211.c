...
LCD_PLATFORM_DATA_BEGIN(lcd_data)
	...
	.lcd_io = {
        .backlight = -1, //IO_PORTA_07,
        .backlight_value = 1,

		.lcd_reset = -1, //IO_PORTA_06,
        .lcd_cs    = IO_PORTH_05, //-1,
        .lcd_lane  = -1, //IO_PORTA_08,
        .lcd_rs    = -1,
        .lcd_spi_ck= -1,
        .lcd_spi_di= -1,
        .lcd_spi_do= -1,
...
WIFI_PLATFORM_DATA_BEGIN(wifi_data)
    ...
    .sdio_parm = SDIO_GRP_1 | SDIO_PORT_0 | SDIO_4_BIT_DATA | SDIO_CLOCK_26M,
#else
    .sdio_parm = SDIO_GRP_1 | SDIO_PORT_0 | SDIO_4_BIT_DATA | SDIO_CLOCK_26M | SDIO_DATA1_IRQ,
#endif

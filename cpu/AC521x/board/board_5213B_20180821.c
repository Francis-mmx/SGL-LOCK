...
int sdmmc_1_io_detect(const struct sdmmc_platform_data *data)
{
    ...
    if (!init) {
        init = 1;
        gpio_direction_input(IO_PORTH_00);
        gpio_set_pull_up(IO_PORTH_00, 1);
        gpio_set_pull_down(IO_PORTH_00, 0);
    }

    return !gpio_read(IO_PORTH_00);
...
SD1_PLATFORM_DATA_BEGIN(sd1_data)
	...
	.data_width 			= 4,
	.speed 					= 40000000,
	.detect_mode 			= SD_IO_DECT, //SD_CMD_DECT,
	.detect_func 			= sdmmc_1_io_detect, //NULL,
...
#define ADKEY_V_3 		((ADC0_23 + ADC0_17)/2)
#define ADKEY_V_4 		((ADC0_17 + ADC0_13)/2)
#define ADKEY_V_5 		((ADC0_13 + ADC0_09)/2)
#define ADKEY_V_6 		((ADC0_09 + ADC0_06)/2)//up 0.7
#define ADKEY_V_7 		((ADC0_06 + ADC0_03)/2)//down 0.4
#define ADKEY_V_8 		((ADC0_03 + ADC0_02)/2)//ok 0.2
#define ADKEY_V_9 		((ADC0_02 + ADC0_01)/2)//menu/mode 0.1

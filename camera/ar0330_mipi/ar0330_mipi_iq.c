...
static isp_iq_params_t ar0330_mipi_iq_params = {
    .blc = {
        0, 0, 0, 0,
    },
    .lsc = {
    ...
    .dpc =   {(10 << 4), (5 << 4), (15 << 4)},
    .tnr =   {1, 32, 175, 25, 175, 25, 230, 0, {384, 256, 256, 256, 256, 256, 230, 230}},
    .nr =    {30, 10, 0},
    .shp =   {2, 20, 64, 64, 160, 160, 96, 96, 0, 8, 192, 8, 192},
    .cnr =   {1, 255, 30},
...
void *AR0330_MIPI_get_iq_params()
{
    return (void *)&ar0330_mipi_iq_params;
}

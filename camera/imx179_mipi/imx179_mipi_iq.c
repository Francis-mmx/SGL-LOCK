...
#include "imx179_mipi_iq.h"
const static u8 gamma_65_65_plus_poly_40_70_192_200[256] = {
...
static isp_iq_params_t imx179_mipi_iq_params = {
    .blc = {
        -256, -256, -256, -256,
    },
    .lsc = {
...
void *imx179_mipi_get_iq_params()
{
    return (void *)&imx179_mipi_iq_params;
}

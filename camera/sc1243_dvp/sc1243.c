...
const sensor_ini_regs_t sc1243_dvp_ini_regs[] = {
...
s32 sc1243_dvp_ID_check(void)
{
    ...
    if (pid == 0x12 && ver == 0x43) {
        puts("----hello sc1243_dvp-----\n");
        return 0;
    }
    puts("----not sc1243_dvp-----\n");
    return -1;
...
REGISTER_CAMERA(sc1243_dvp) = {
    ...
    .isp_size 			= 	{SC1243_DVP_OUTPUT_W - 16, SC1243_DVP_OUTPUT_H - 16},

    .cap_fps         		= 	25,
    .sen_cap_size 			= 	{SC1243_DVP_OUTPUT_W, SC1243_DVP_OUTPUT_H},
    .isp_cap_size 			= 	{SC1243_DVP_OUTPUT_W - 16, SC1243_DVP_OUTPUT_H - 16},

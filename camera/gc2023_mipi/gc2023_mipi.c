...
const Sensor_reg_ini GC2023_MIPI_INI_REG[] = {
...
s32 GC2023_MIPI_ID_check(void)
{
    ...
    if (pid != 0x20 || ver != 0x23) {
        puts("----not GC2023_MIPI-----\n");
        return -1;
    }
    puts("----hello GC2023_MIPI-----\n");
    return 0;
}
...
u32 gc2023_mipi_set_shutter(isp_ae_shutter_t *shutter)
{
    ...
    wrGC2023_MIPIRegArray(gc2023_mipi_shutter_cmd[0], 18);

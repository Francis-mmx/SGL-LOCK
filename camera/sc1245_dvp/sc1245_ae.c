...
extern u32 sc1245_dvp_set_shutter(isp_ae_shutter_t *shutter);
...
void sc1245_dvp_ae_ev_init(u32 fps)
{
    u32 time, gain;
    int minev, maxev;
    ...
    sc1245_dvp_calc_shutter(&ae_shutter, time, gain);

    sc1245_dvp_set_shutter(&ae_shutter);
}

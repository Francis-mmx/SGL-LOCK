...
#define	GC0308_FPS_25 25
#define	GC0308_FPS_20 20
#define	GC0308_FPS_15 15
#define	GC0308_FPS_10 10
#define	GC0308_FPS_5  5

#define CONFIG_INPUT_FPS	GC0308_FPS_20
#define CONFIG_OUTPUT_FPS	GC0308_FPS_20
...
#if (CONFIG_INPUT_FPS == GC0308_FPS_5)
    //5 fps
    wrGC0308Reg(0x0f, 0x24);
    wrGC0308Reg(0x01, 0x80);
    wrGC0308Reg(0x02, 0xff);
#elif (CONFIG_INPUT_FPS == GC0308_FPS_10)

    //10 fps
    wrGC0308Reg(0x0f, 0x11);
    wrGC0308Reg(0x01, 0xff);
    wrGC0308Reg(0x02, 0xff);
#elif (CONFIG_INPUT_FPS == GC0308_FPS_15)

    //15 fps
    wrGC0308Reg(0x0f, 0x01);
    wrGC0308Reg(0x01, 0x80);
    wrGC0308Reg(0x02, 0xf8);
#elif (CONFIG_INPUT_FPS == GC0308_FPS_20)

    //20 fps
    wrGC0308Reg(0x0f, 0x00);
    wrGC0308Reg(0x01, 0x80);
    wrGC0308Reg(0x02, 0xf8);
#elif (CONFIG_INPUT_FPS == GC0308_FPS_25)
...
REGISTER_CAMERA(GC0308) = {
    ...
    .mbus_config        =   SEN_MBUS_DATA_WIDTH_8B  | SEN_MBUS_HSYNC_ACTIVE_HIGH | SEN_MBUS_PCLK_SAMPLE_FALLING | SEN_MBUS_VSYNC_ACTIVE_HIGH,

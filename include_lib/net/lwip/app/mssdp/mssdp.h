...
int mssdp_init(const char *search_prefix, const char *notify_prefix, u16_t port, void (*recv_func)(u32 dest_ipaddr, enum mssdp_recv_msg_type type, char *buf, void *priv), void *priv);

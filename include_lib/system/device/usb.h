...
#ifdef USB_ONLY_SUPPORT_SLAVE_MASS_STORAGE
...
/*********************************/
#define UVCIOC_GET_FMT                  _IOR('U', 25, sizeof(unsigned int))
#define USBIOC_UAC_SPEAKER_CONNECT      _IOW('U', 26, sizeof(struct _usb_audio_arg))
#define USBIOC_GET_USB_PORT             _IOR('U', 27, sizeof(unsigned int))

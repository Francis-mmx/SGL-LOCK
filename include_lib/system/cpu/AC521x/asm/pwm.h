...
#if 0
#define PWMCH0_CMP_REG_W		_IOW('P',8,u32)
#define PWMCH1_CMP_REG_W		_IOW('P',9,u32)
#define PWMCH2_CMP_REG_W		_IOW('P',10,u32)
#define PWMCH3_CMP_REG_W		_IOW('P',11,u32)
#define PWMCH4_CMP_REG_W		_IOW('P',12,u32)
#define PWMCH5_CMP_REG_W		_IOW('P',13,u32)

...
#define PWD_1   (('6'    << 24) | ('6' << 16) | ('6' << 8) | ('6' << 0))//0000 0001 0000 0010 0000 0011 0000 0110  Hex 1020306
#define PWD_2   (('1'    << 24) | ('2' << 16) | ('3' << 8) | ('4' << 0))//0000 0101 0000 0100 0000 0111 0000 1000

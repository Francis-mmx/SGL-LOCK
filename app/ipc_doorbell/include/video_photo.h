...
#define     LOW_QUALITY0     (550 * 1024)
#define     LOW_QUALITY      (1 * 1024 * 1024 + 512 * 1024)
#define     MED_QUALITY      (1 * 1024 * 1024 + 768 * 1024)
#define     HIG_QUALITY      (2 * 1024 * 1024 + 256 * 1024)
#define     HD_QUALITY       (3 * 1024 * 1024 + 512 * 1024)
...
#define     IMAGE_AUX_BUF_SIZE        HIG_QUALITY
#else
#define     IMAGE_AUX_BUF_SIZE        LOW_QUALITY0//HD_QUALITY
#endif
...
#define PHOTO_CAMERA_NUM        3

#ifdef PHOTO_STICKER_ENABLE
#define PHOTO_STICKER_NUM       3
#define PHOTO_STICKER_NAME		"st%06d.jpg"
#define PHOTO_STICKER_PATH      "mnt/spiflash/audlogo/"PHOTO_STICKER_NAME
#endif
...
struct video_photo_handle {
    ...
    struct image_sticker icon_sticker[4]; //小贴纸
